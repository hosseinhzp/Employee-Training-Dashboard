...
async function getData(): Promise<Data[]> {
  const items: Data[] = [
    ...
    {
      id: "T-005",
      course: "Testing Best Practices",
      assignee: "Amélie Rousseau",
      dueDate: "2025-11-05",
      status: "Overdue",
      progress: 60,
      hours: 4,
    ...
    {
      id: "T-014",
      course: "Customer Support Training",
      assignee: "Mia Pereira",
      dueDate: "2025-11-08",
      status: "Overdue",
      progress: 40,
